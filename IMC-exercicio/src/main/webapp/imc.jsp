...
<body>
		...
		<div class="row login">
			<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 well">
				<form role="form">
					...
					<div class="form-group">
						<button type="submit"
							class="btn btn-default btn-lg btn-block btn-success">Calcular</button>
						<br> <br>
	...
	<%
		...
		String alturacap = request.getParameter("altura");
		alturacap = alturacap == null ? "0" : alturacap;
		float altura = Float.parseFloat(alturacap);
